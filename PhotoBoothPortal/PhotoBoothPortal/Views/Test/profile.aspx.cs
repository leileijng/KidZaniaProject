                    ...
                    foreach (var photo in photoprofile)
                    {
                        ...
                        using (WindowsIdentity.GetCurrent().Impersonate())
                        {
                            if (!File.Exists(currentApplicationPath + "profiles//" + local_photoimage))
                                File.Copy(Constants.REMOTE_FOLDER_APIVM + photoprofileimage, currentApplicationPath + "profiles\\" + local_photoimage, true);
                            else
                            {
                                File.Delete(currentApplicationPath + "profiles//" + local_photoimage);
                                File.Copy(Constants.REMOTE_FOLDER_APIVM + photoprofileimage, currentApplicationPath + "profiles//" + local_photoimage);
                            }
                        }
